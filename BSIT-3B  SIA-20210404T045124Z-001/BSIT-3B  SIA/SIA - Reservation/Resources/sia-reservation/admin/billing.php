                        ...
                        <tr class="gradeX">
                            ...
                            <td>
                                <?php $status = $row->status;?>
                                  ...
                                  <!--  <button type="button" data-toggle="modal" data-id="<?php echo $row->id;?>" data-target="#checkout_modal_notpaid" class="checkout1 btn btn-danger btn-sm">Check Out</button>  -->                              
                            </td>
                        </tr>
                        <?php endwhile; ?>
