    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b style="font-family:'Courier New', Courier, monospace;">Add Attendance</b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="attendance_add.php">
          		  <div class="form-group">
                  	<label style="font-family:'Courier New', Courier, monospace;" for="employee" class="col-sm-3 control-label">Employee ID</label>
                ...
                <div class="form-group">
                    <label style="font-family:'Courier New', Courier, monospace;" for="datepicker_add" class="col-sm-3 control-label">Date</label>
