	...
	<form action="" id="employee-attendance">
		<div class="row form-group">
			...
			<div class="col-md-3">
				...
				<input type="text" id="adate" placeholder="click me">
			</div>
			<div class="col-md-2">
...
<script>
	var dtt = document.getElementById('adate')
	...
	var whole = year + "-" + (month + 1)+ "-" + date + " " + hour + ":" + minute;
    document.getElementById('adate').value=whole;
	}
