			...
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-header">
						<span><b>Food Menu List</b></span>
						<button class="btn btn-primary btn-sm btn-block col-md-3 float-right" type="button" id="new_foodmenu_btn"><span class="fa fa-plus"></span> Add New Menu</button>
					</div>
					<div class="card-body">
