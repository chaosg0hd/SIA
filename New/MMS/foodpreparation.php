			...
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-header">
						<span><b>Food Preparation List</b></span>
						<button class="btn btn-primary btn-sm btn-block col-md-3 float-right" type="button" id="new_food_btn"><span class="fa fa-plus"></span> Add to Prepare Food</button>
					</div>
					<div class="card-body">
