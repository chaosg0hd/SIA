...
<nav class="navbar navbar-light fixed-top bg-primary" style="padding:0;min-height:5rem;font-size: 15px;">
      ...
      <img src="cocolimelogo.png" width="150" height="50">
        <large><b>Coco Lime Management System</b></large>
	  	...
	  	<div class="col-md-2 float-right text-white">
	  		<a href="../login.php" class="text-white"><?//php echo $_SESSION['login_name']; 
              session_destroy(); ?> <i class="fa fa-power-off"></i></a>
	    </div>
    </div>
    <div class="topbar2">
  <ul>
  ...
  <li><a href="../landing.php" style="font-size: 12.5px;">Navigation</a></li>
</ul>
</div>
  </div>
