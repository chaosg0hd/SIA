...
<body class="hold-transition menunavbar sidebar-mini">
<div class="wrapper">
...
$(function(){
  ...
  barChartData.datasets[1].fillColor   = '#15663c'
  barChartData.datasets[1].strokeColor = '#15663c'
  barChartData.datasets[1].pointColor  = '#15663c'
  var barChartOptions                  = {
