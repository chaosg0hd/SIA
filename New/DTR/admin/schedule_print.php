...
<div class="container">
  <div class="row">
    <div class="col-md-12">
		<br>
      <b style="font-family:'Courier New', Courier, monospace; font-size:50px; margin-left:270px;" >EMPLOYEES SCHEDULE</b>
      <table class="table table-bordered print">
        ...
        <tbody>
          <?php
				$n=1;
				$sql="SELECT * FROM employees, schedules";
	  ...
	  <a href="schedule_employee.php"><button style="font-family:'Courier New', Courier, monospace;" class="btn btn-danger btn-flat" id="print-btn">BACK</button>
		<button style="font-family:'Courier New', Courier, monospace;" onclick="window.print();" class="btn btn-success btn-flat" id="print-btn">PRINT</button>
      </div>
    </div>
  </div>
</div>
