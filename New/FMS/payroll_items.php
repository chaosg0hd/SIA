...
?>
			...
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-header">
						...
						<button class="btn btn-primary float-left" type="button" id="new_payroll_btn1"><span class="fa fa-arrow-left">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('#new_payroll_btn1').click(function(){
				location.href = "index.php?page=payroll&id="
			})
